...
ActiveRecord::Schema.define(version: 20200401003901) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.integer "rating"
    t.string "content"
    t.string "picture", default: "https://www.bigi.id/media/catalog/product/placeholder/default/default-no-image_2.png"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "shelter_id"
